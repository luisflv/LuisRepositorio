/*2*/
SELECT a.NOME_ALUNO, c.NOME_CURSO FROM TBMATRICULA AS m 
INNER JOIN TBALUNO AS a ON a.ID_ALUNO =  m.ALUNO_ID  
...
/*8*/
SELECT a.NOME_ALUNO, c.ID_CURSO FROM TBMATRICULA AS m 
INNER JOIN TBALUNO AS a 
ON a.ID_ALUNO = m.ALUNO_ID  
INNER JOIN TBCURSO AS c 
ON c.ID_CURSO = m.CURSO_ID  WHERE c.ID_CURSO = 1 AND SEXO = 'F'
